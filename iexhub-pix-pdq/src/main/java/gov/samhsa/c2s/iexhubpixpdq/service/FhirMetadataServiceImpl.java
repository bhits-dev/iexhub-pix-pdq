...
import gov.samhsa.c2s.iexhubpixpdq.service.exception.FhirMetadataServiceException;
...
public class FhirMetadataServiceImpl implements FhirMetadataService {
    ...
    public FhirMetadataDto generateFhirMetadata() {
        final IexhubPixPdqProperties.Fhir.CapabilityStatement capabilityStatementProperties = iexhubPixPdqProperties.getFhir().getCapabilityStatement();
